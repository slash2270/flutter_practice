...
class TextWaterMarkPainterStagger1 extends WaterMarkPainter {
  TextWaterMarkPainterStagger1({
    required this.text,
    this.padding1,
  ...
  Size paintUnit(Canvas canvas, double devicePixelRatio) {
    final TextWaterMarkPainter1 painter = TextWaterMarkPainter1(
      text: text,
      padding: padding1,
      rotate: rotate ?? 0,
      textStyle: textStyle
  ...
  @override
  bool shouldRepaint(TextWaterMarkPainterStagger1 oldPainter) {
