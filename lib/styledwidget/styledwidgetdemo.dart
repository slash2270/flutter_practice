...
class StyleUserPage extends StatelessWidget {
  @override
...
class StyleUserCard extends StatelessWidget {
...
class StyleActionsRow extends StatelessWidget {
...
class StyleSettingsItemModel {
  final IconData icon;
  final Color color;
  final String title;
  final String description;
  const StyleSettingsItemModel({
    required this.color,
...
const List<StyleSettingsItemModel> settingsItems = [
  StyleSettingsItemModel(
...
class StyleSettings extends StatelessWidget {
  ...
  Widget build(BuildContext context) => settingsItems
      .map((settingsItem) => StyleSettingsItem(
    settingsItem.icon,
    settingsItem.color,
    settingsItem.title,
...
class StyleSettingsItem extends StatefulWidget {
  StyleSettingsItem(this.icon, this.iconBgColor, this.title, this.description);
  ...
  @override
  _StyleSettingsItemState createState() => _StyleSettingsItemState();
}

class _StyleSettingsItemState extends State<StyleSettingsItem> {
  bool pressed = false;
