...
class StyleWidgetToggle extends StatefulWidget {
  @override
  _StyleWidgetToggleState createState() => _StyleWidgetToggleState();
}

class _StyleWidgetToggleState extends State<StyleWidgetToggle> {
