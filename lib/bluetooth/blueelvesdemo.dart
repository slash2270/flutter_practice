...
class BlueElvesDemo extends StatefulWidget {
  const BlueElvesDemo({Key? key}) : super(key: key);

  @override
  State<BlueElvesDemo> createState() => _BlueElvesDemoState();
}

class _BlueElvesDemoState extends State<BlueElvesDemo> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
            ...
            children: Platform.isAndroid
              ...
              TextButton.icon(
                ...
                icon: Icon(_iosBlueState == IosBluetoothState.poweredOn
                    ? Icons.done
                    : Icons.error),
                label: Text("BlueToothState:" + _iosBlueState.toString().replaceAll(RegExp("IosBluetoothState."), ""),
                    ...
                    Expanded(
                      ...
                      child: Column(children: [
                        ...
                        ElevatedButton(
                          ...
                          onPressed: () {
                            Text('Connected name = ${currentConnected._name}\nmacAddress = ${currentConnected._macAddress}\ndevice = ${currentConnected._device}');
                          },
                        )
                      ]),
                    ),
                            ...
                            children: [
                              ElevatedButton(
                                  onPressed: () {
                                    ...
                                    Text('Hide name = ${currentHide.name}\nmacAddress = ${currentHide.macAddress}\nstate = ${toConnectDevice.state.name}');
                                  },
                          ...
                          children: [
                            ElevatedButton(
                                onPressed: () {
                                  ...
                                  Text('Scan name = ${currentScan.name}\nmacAddress = ${currentScan.macAddress}\nuuids = ${currentScan.uuids}');
                                },
                                child: const Text("Connect")),
      ...
      floatingActionButton: FloatingActionButton(
        ...
        tooltip: 'scan',
        child: Icon(_isScanning ? Icons.stop : Icons.find_replace),
