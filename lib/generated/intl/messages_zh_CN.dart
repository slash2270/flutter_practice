...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        "First": MessageLookupByLibrary.simpleMessage("第一页"),
        "all_service_and_characteristics":
            MessageLookupByLibrary.simpleMessage("所有的服务及其子特征值"),
        "ble_connecting": MessageLookupByLibrary.simpleMessage("正在连接蓝牙..."),
        "ble_disconnet_connecting":
            MessageLookupByLibrary.simpleMessage("蓝牙连接断开，正在重新连接蓝牙..."),
        "connect_time_out_check_whether_ble_is_turned_on":
            MessageLookupByLibrary.simpleMessage("蓝牙连接超时，请检查蓝牙是否打开"),
        "language":
        ...
        "set_notify_characteristics":
            MessageLookupByLibrary.simpleMessage("设置通知特征值（多选）"),
        "set_write_characteristics":
            MessageLookupByLibrary.simpleMessage("设置写特征值(单选)"),
        "start_searching_for_attached_bluetooth_devices":
            MessageLookupByLibrary.simpleMessage("开始搜索附近的蓝牙设备"),
