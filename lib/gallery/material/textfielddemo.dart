        ...
        suffixIcon: IconButton(
          ...
          icon: Icon(
            ...
            semanticLabel: _obscureText.value
                ? 'TextFieldShowPasswordLabel'
                : 'TextFieldHidePasswordLabel',
          ),
        ),
      ),
    );
...
class TextFormFieldDemoState extends State<TextFormFieldDemo>
  ...
  void _handleSubmitted() {
    ...
    if (!form.validate()) {
      ...
      showInSnackBar('TextFieldFormErrors',);
    } else {
      form.save();
  ...
  String? _validateName(String? value) {
    ...
    if (!nameExp.hasMatch(value)) {
      return 'TextFieldOnlyAlphabeticalChars';
    }
    return null;
  }
  ...
  String? _validatePhoneNumber(String? value) {
    ...
    if (!phoneExp.hasMatch(value!)) {
      return 'TextFieldEnterUSPhoneNumber';
    }
    return null;
  }
  ...
  String? _validatePassword(String? value) {
    ...
    if (passwordField.value == null || passwordField.value!.isEmpty) {
      return 'TextFieldEnterPassword';
    }
    if (passwordField.value != value) {
      return 'TextFieldPasswordsDoNotMatch';
    }
    return null;
  }
            ...
            children: [
              ...
              TextFormField(
                ...
                decoration: InputDecoration(
                  ...
                  hintText: 'TextFieldWhatDoPeopleCallYou',
                  labelText: 'TextFieldNameField',
                ),
                onSaved: (value) {
                  person.name = value;
              ...
              TextFormField(
                ...
                decoration: InputDecoration(
                  ...
                  hintText: 'TextFieldWhereCanWeReachYou',
                  labelText: 'TextFieldPhoneNumber',
                  prefixText: '+1 ',
                ),
              ...
              TextFormField(
                ...
                decoration: InputDecoration(
                  ...
                  hintText: 'TextFieldYourEmailAddress',
              ...
              TextFormField(
                ...
                decoration: InputDecoration(
                  ...
                  hintText: 'TextFieldTellUsAboutYourself',
                  helperText: 'TextFieldKeepItShort',
                  labelText: 'TextFieldLifeStory',
                ),
                maxLines: 3,
              ),
              sizedBoxSpace,
              TextFormField(
                ...
                decoration: InputDecoration(
                  border: const OutlineInputBorder(),
                  labelText: 'TextFieldSalary',
                  suffixText: 'TextFieldUSD',
                ),
                maxLines: 1,
              ),
              sizedBoxSpace,
              PasswordField(
                ...
                helperText: 'TextFieldNoMoreThan',
              ...
              TextFormField(
                ...
                decoration: InputDecoration(
                  filled: true,
                  labelText: 'TextFieldRetypePassword',
                ),
                maxLength: 8,
                obscureText: true,
              ...
              Center(
                child: ElevatedButton(
                  ...
                  child: Text('TextFieldSubmit'),
                ),
              ),
              sizedBoxSpace,
              Text('TextFieldRequiredField',
